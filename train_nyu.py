...
parser.add_argument('--pre_trained_model', type=str, default='resnet_v2_101.ckpt',
...
def get_filenames(is_training, data_dir):
  ...
  """
  if is_training:
    return [os.path.join(data_dir, 'nyu_train.record')]
  else:
    return [os.path.join(data_dir, 'nyu_val.record')]
