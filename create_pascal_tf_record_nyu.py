...
parser.add_argument('--data_dir', type=str, default='/home/amittel/Desktop/Consistent_Semantic_Segmentation/NYU',
                    help='Path to the directory containing the PASCAL VOC data.')

parser.add_argument('--output_path', type=str, default='./dataset_nyu',
                    help='Path to the directory to create TFRecords outputs.')

parser.add_argument('--train_data_list', type=str, default='./dataset_nyu/train.txt',
                    help='Path to the file listing the training data.')

parser.add_argument('--valid_data_list', type=str, default='./dataset_nyu/validation.txt',
                    help='Path to the file listing the validation data.')

parser.add_argument('--image_data_dir', type=str, default='images',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='labels',
...
def create_tf_record(output_filename,
  ...
  for idx, example in enumerate(examples):
    ...
    label_path = os.path.join(label_dir, example + '.jpg')
...
def main(unused_argv):
  ...
  tf.logging.info("Reading from NYU dataset")
  ...
  train_output_path = os.path.join(FLAGS.output_path, 'nyu_train.record')
  val_output_path = os.path.join(FLAGS.output_path, 'nyu_val.record')
